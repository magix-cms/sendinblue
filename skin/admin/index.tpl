...
{block name='head:title'}sendinblue{/block}
                ...
                <div class="panel-body panel-body-form">
                    ...
                    <div class="tab-content">
                        {if isset($api.api_key)}<div role="tabpanel" class="tab-pane active" id="general">
                            {include file="section/form/table-form-3.tpl" idcolumn='id_list' data=$lists activation=false sortable=false controller="sendinblue"}
                        </div>{/if}
