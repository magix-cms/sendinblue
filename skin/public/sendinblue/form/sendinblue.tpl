        ...
        <div class="row row-center">
            <div class="col-12 col-md-10 col-lg-9 col-xl-7">
                <div class="mailchimp">
                    ...
                    <form id="mailchimp-form" method="post" action="{$url}/{$lang}/sendinblue/" class="validate_form nice-form">
                        <div class="row">
                        ...
                        <div class="text-center">
                            <p><input type="submit" class="btn btn-box btn-lg btn-sd-theme" value="{#sendinblue_validate_inscription#}"/></p>
